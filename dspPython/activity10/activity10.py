...
def read_pdf_file(file_path):
    try:
        ...
        if not text.strip():
            print("⚠️ The PDF file has no readable text (it might be scanned or image-only).")
        else:
...
if __name__ == "__main__":
    pdf_path = r"C:\Users\katri\OneDrive\Documents\DSP\dspPython\activity10\docs\tangled_story.pdf"
