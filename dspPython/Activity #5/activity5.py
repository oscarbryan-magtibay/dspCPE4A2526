...
lower_darkblue = np.array([100, 150, 50])
upper_darkblue = np.array([130, 255, 255])
...
while True:
    ...
    mask = cv2.inRange(hsv_frame, lower_darkblue, upper_darkblue)
    ...
    if target_cx is not None:
        ...
        cv2.putText(frame, "Dark Blue object detected",
                    (10, 30),
